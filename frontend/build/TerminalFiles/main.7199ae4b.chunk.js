      ...
      var a,
          ...
          (function (e) {
            ...
            function n(e) {
              ...
              var i = !!e.autocomplete,
                r = !1 === e.autostart
              return (
                (a._cursorInterval = e.speed || a._cursorInterval),
                (a.state = { index: 0, char: 0, active: !1, done: i, paused: r }),
              ...
              Object(f.a)(n, [
                {
                  ...
                  value: function () {
                    ...
                    return l.a.createElement(
                      'div',
                      { className: m },
                      l.a.createElement('span', { className: 'visible' }, c),
                      l.a.createElement('span', { className: 'cursor', ref: this._cursorRef }, o),
                      l.a.createElement('span', { className: 'hidden' }, u)
                    )
                  },
                },
                {
                ...
                },
                {
                  ...
                  value: function () {
                    null !== this._animateTimerId &&
                      (clearTimeout(this._animateTimerId), (this._animateTimerId = null))
                  },
                },
                {
                  key: '_animate',
                ...
                },
                {
                  ...
                  value: function () {
                    null !== this._animateTimerId &&
                      (window.clearTimeout(this._animateTimerId), (this._animateTimerId = null))
                  },
                },
                {
                  key: '_updateState',
                  value: function () {
                    ...
                    if (!i) {
                      var s = n,
                        ...
                        l = r
                      c || (c = !0),
                        n < e.length ? (s = n + 1) : ((c = !1), (o = !0)),
                        this.setState({ char: s, active: c, done: o, paused: l })
                    }
                  },
                },
                {
        ...
        k = function (e) {
          ...
          return (
            ...
            l.a.createElement('div', { className: i }, t)
          )
        },
        E = (n(22), [0.01, 0.02, 0.03, 0.05, 0.08, 0.13, 0.21, 0.34, 0.55, 0.89, 1]),
        N = (function (e) {
          Object(y.a)(n, e)
          var t = Object(h.a)(n)
          function n(e) {
            ...
            Object(p.a)(this, n),
              ...
              (a._clearAnimationTimer = function () {
                a._animateTimerId &&
                  (window.clearInterval(a._animateTimerId), (a._animateTimerId = null))
              }),
              (a._canvasRef = l.a.createRef())
            var i = !a.props.autocomplete
            return (a.state = { loading: i, image: new Image() }), a
          }
          return (
            Object(f.a)(n, [
              {
                ...
                value: function () {
                  ...
                  return l.a.createElement(
                    'div',
                    { className: n },
                    t && l.a.createElement('div', { className: 'progressbar' }),
                    l.a.createElement('canvas', { ref: this._canvasRef })
                  )
                },
              },
              {
                ...
                value: function () {
                  ...
                  this._clearAnimationTimer(),
                    (this._animateTimerId = window.setInterval(function () {
                      e._currentStep < E.length
                        ? (e._resampleImage(E[e._currentStep]), e._currentStep++)
                        : (e._clearAnimationTimer(), t && t())
                    }, 150))
                },
              },
              {
          ...
          function (e) {
            ...
            return (
              ...
              l.a.createElement(
                ...
                n && l.a.createElement('span', { className: 'prompt' }, n),
                l.a.createElement('span', { className: 'input', ref: c }, p)
              )
            )
          }),
        A =
          ...
          function (e) {
            ...
            return (
              ...
              l.a.createElement('div', { className: i, onClick: p }, s)
            )
          }),
        C =
          (n(25),
              ...
              l.a.createElement(
                ...
                l.a.createElement(
                  ...
                  ('string' === typeof t ? [t] : t).map(function (e, t) {
                    return l.a.createElement('p', { key: t }, e)
                  })
                )
              )
            )
        ...
        O =
          (n(26),
          function () {
            return l.a.createElement('section', { className: '__scanlines__' })
          }),
        T = n(9)
      !(function (e) {
          ...
          Object(f.a)(n, [
            {
              ...
              value: function () {
                ...
                return l.a.createElement(
                  ...
                  l.a.createElement(
                    'section',
                    { className: '__main__', ref: this._containerRef },
                    t && this._renderScreen()
                  ),
                  n && this._renderDialog(),
                  a && l.a.createElement(O, null)
                )
              },
            },
            {
            ...
            },
            {
              ...
              value: function () {
                ...
                if (t.length) {
                  this.setState({ screens: t }, function () {
            ...
            },
            {
              ...
              value: function () {
                ...
                t.length && this.setState({ dialogs: t })
              },
            },
            {
              key: '_buildDialog',
              value: function (e) {
                var t = e.id || null,
                  ...
                  i = null
                return n === a.Alert && (i = e.content), { id: t, type: n, content: i }
              },
            },
            {
              key: '_getDialogType',
            ...
            },
            {
              ...
              value: function (e) {
                ...
                this.setState({ activeScreenId: n }, function () {
                ...
                switch (e.type) {
                  ...
                  case i.Screen:
                    ;(e.content[0].state = s.Active),
                      this.setState({ status: t, activeElementId: e.content[0].id })
                }
              },
            },
            {
              ...
              value: function (e) {
                ...
                if (t && n) return { id: t, type: n, content: a }
              },
            },
            {
              key: '_getScreenType',
              ...
              value: function () {
                ...
                if (t)
                  return t.content.map(function (t, n) {
                    return t.state === s.Ready
                      ? null
                      : t.state === s.Active
                      ? l.a.createElement(
                          'div',
                          { className: 'active', key: n },
                          e._renderActiveElement(t, n)
                        )
                      : t.state === s.Done
                      ? l.a.createElement(
                          'div',
                          { className: 'rendered', key: n },
                          e._renderStaticElement(t, n)
                        )
                      : null
                  })
              },
            ...
            },
            {
              ...
              value: function (e) {
                ...
                if (n) {
                  ...
                  a.push(e.id), this.setState({ loadingQueue: a })
                }
                var i = n ? s.Unloaded : s.Ready
                if ('string' === typeof e) return { id: t, type: r.Text, text: e, state: i, onLoad: n }
                if (e.type)
                  switch (e.type.toLowerCase()) {
                    ...
                    case 'toggle':
                      return { id: t, type: r.Toggle, states: e.states, state: i }
                    default:
                      return
                  }
              },
            ...
            },
            {
              ...
              value: function (e, t) {
                ...
                if (e.type === r.Text) {
                  ...
                  return l.a.createElement(k, { key: t, className: a, text: c, onRendered: i })
                }
                if (e.type === r.Link)
                ...
                return e.type === r.Prompt
                  ...
                  : e.type === r.Toggle
                  ? l.a.createElement(A, { key: t, className: a, states: e.states })
                  : null
              },
            },
            {
              ...
              value: function (e) {
                ...
                ;(t.state = s.Active),
                  this.setState({ activeScreenId: e, activeElementId: t.id, status: c.Active })
              },
            },
            {
            ...
            },
            {
              ...
              value: function () {
                ...
                ;-1 !== t &&
                  ((e.content[t].state = s.Done),
                  t !== e.content.length - 1
                    ? ((e.content[t + 1].state = s.Active),
                      this.setState({ activeElementId: e.content[t + 1].id }))
                    : this.setState({ activeElementId: null, status: c.Done }))
              },
            },
            {
            ...
            },
            {
              key: '_toggleDialog',
              value: function (e) {
                this.setState({ activeDialogId: e || null })
              },
            },
            {
            ...
            { key: '_handleTeletypeNewLine', value: function () {} },
            {
